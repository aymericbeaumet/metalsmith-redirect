...
test.cb(
  "normalize().appendHTMLIndexIfNeeded().get() should return the path without any modification if it's not a directory",
  t => {
    const refs = [
      'foo/index.md',
      '/foo/index.md',
...
test.cb(
  "normalize().appendHTMLIndexIfNeeded().get() should return the path with a HTML index appended if it's a directory",
  t => {
    const refs = {
      foo: 'foo/index.html',
      '/foo': '/foo/index.html',
...
test.cb(
  'normalize().ensureHTML() should not throw an exception if the wrapped path ends with a HTML file',
  t => {
    const refs = [
      'index.html',
      '/index.html',
